...
async function inputInventory(inv_make,
    inv_model,
    inv_year,
    inv_description,
    inv_image,
  ...
  try {
    ...
    classification_id])
      ...
      console.log("Error in inputInventory function:", error.message); 
...
module.exports = {getClassifications, getInventoryByClassificationID, getVehicleById, inputInventory, inputClassification };
